-- Commodity Hedging & VaR Demo - Seed Data
-- Demo user, commodities, and sample data

-- Insert demo user (password: demo123)
-- Password hash generated with bcrypt for "demo123"
INSERT INTO users (id, username, password_hash) VALUES
    ('00000000-0000-0000-0000-000000000001', 'demo', '$2b$12$LpA5dANbpvecyGItCFm98uCbLDR1Ff/jKK/c5GLkanW6BWRdbByOy');
...
-- Insert historical purchases (6-12 months)
-- Sugar purchases
INSERT INTO purchases (commodity_id, purchase_date, delivery_start_date, delivery_end_date, quantity, unit, purchase_price) VALUES
    ('11111111-1111-1111-1111-111111111111', '2025-07-15', '2025-08-01', '2025-10-31', 50000, 'kg', 0.45),
    ('11111111-1111-1111-1111-111111111111', '2025-08-20', '2025-09-01', '2025-11-30', 60000, 'kg', 0.48),
    ('11111111-1111-1111-1111-111111111111', '2025-09-10', '2025-10-01', '2025-12-31', 55000, 'kg', 0.46),
    ('11111111-1111-1111-1111-111111111111', '2025-10-05', '2025-11-01', '2026-01-31', 70000, 'kg', 0.50),
    ('11111111-1111-1111-1111-111111111111', '2025-11-12', '2025-12-01', '2026-02-28', 65000, 'kg', 0.49),
    ('11111111-1111-1111-1111-111111111111', '2025-12-01', '2026-01-01', '2026-03-31', 75000, 'kg', 0.51),
    ('11111111-1111-1111-1111-111111111111', '2026-01-10', '2026-02-01', '2026-04-30', 80000, 'kg', 0.52);

-- Flour purchases
INSERT INTO purchases (commodity_id, purchase_date, delivery_start_date, delivery_end_date, quantity, unit, purchase_price) VALUES
    ('22222222-2222-2222-2222-222222222222', '2025-07-20', '2025-08-01', '2025-10-31', 40000, 'kg', 0.35),
    ('22222222-2222-2222-2222-222222222222', '2025-08-25', '2025-09-01', '2025-11-30', 45000, 'kg', 0.37),
    ('22222222-2222-2222-2222-222222222222', '2025-09-15', '2025-10-01', '2025-12-31', 42000, 'kg', 0.36),
    ('22222222-2222-2222-2222-222222222222', '2025-10-10', '2025-11-01', '2026-01-31', 50000, 'kg', 0.38),
    ('22222222-2222-2222-2222-222222222222', '2025-11-18', '2025-12-01', '2026-02-28', 48000, 'kg', 0.37),
    ('22222222-2222-2222-2222-222222222222', '2025-12-05', '2026-01-01', '2026-03-31', 55000, 'kg', 0.39),
    ('22222222-2222-2222-2222-222222222222', '2026-01-15', '2026-02-01', '2026-04-30', 60000, 'kg', 0.40);

-- Insert inventory snapshots
INSERT INTO inventory_snapshots (date, commodity_id, quantity) VALUES
    ('2026-01-20', '11111111-1111-1111-1111-111111111111', 15000),
    ('2026-01-20', '22222222-2222-2222-2222-222222222222', 12000);

-- Insert sample historical market prices (last 6 months)
